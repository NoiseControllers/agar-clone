(function(f, l) {
    ...
    if (f.location.ancestorOrigins && f.location.ancestorOrigins.length && "https://apps.facebook.com" != f.location.ancestorOrigins[0]) f.top.location = "http://agar.io/";
        ...
        var na, g, C, r, s, M = null,
            ...
            ya = new Image;
        ya.src = "http://agar.io/img/split.png";
            ...
            va.prototype = {
                ...
                B: function(a) {
                    if (this.K()) {
                        ...
                        !this.j && Pa && ":teams" != N ? -1 != Aa.indexOf(d) ? (K.hasOwnProperty(d) || (K[d] = new Image, K[d].src = SKIN_URL + d + ".png"), c = 0 != K[d].width && K[d].complete ? K[d] : null) : c = null : c = null;
